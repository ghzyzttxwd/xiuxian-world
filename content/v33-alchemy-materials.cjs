...
const recipes=[
 ...
 R('recipe-v33-barrierbreak','item-pill-v33-barrierbreak','破障丹',9,'huang',L.cangwu,{'mat-v33-purple-sun-flower':2,'mat-v33-alchemy-cinnabar':1},{buff:{breakthrough:.035},buffDays:10},10,.58,2,'短期辅助小境界破关，不保证成功。',false,{stones:12,insight:1}),
