...
// In explore(), combat/event/minor-event thresholds precede the named-material window.
// At both authored locations danger + eventRate + .22 >= 1, so ordinary noncombat named gather
// is unreachable; a compatible combat source is therefore required for this material.
