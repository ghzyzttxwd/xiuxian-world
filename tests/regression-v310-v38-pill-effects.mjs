...
// Prove V6 is exactly V5 plus the intended V38 pill-schema/runtime consumer changes.
...
// 大乘证道丹 must really supply its authored +7% breakthrough buff and +1 insight.
{
 const api=makeApi();
...
// V38 one-shot recovery keys must execute through the established hp/qi consumer.
{
 const api=makeApi();
