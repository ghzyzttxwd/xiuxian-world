...
> 创建日期：2026-08-23
> 最近重大修订：2026-08-24 · V3.4 战斗与四大道途完整 Build 正式完成
> 当前正式基线：V3.4.0 · 战斗与四大道途 Build · build 3401 · save schema 31
...
| 存档 | schema31；保留 `xiuxian_world_v02` | schema30 → 31 迁移 PASS，future schema32 保护 PASS |
...
- V3.4 schema31 是当前正式存档基线，后续版本必须继续提供逐级迁移。
