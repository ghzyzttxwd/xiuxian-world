...
> 创建日期：2026-08-23
> 最近重大修订：2026-08-24 · V3.3 炼丹、材料与资源闭环正式完成
> 当前正式基线：V3.3.0 · 炼丹材料资源闭环 · build 3301 · save schema 30
...
| 存档 | schema30；保留 `xiuxian_world_v02` | schema29 → 30 迁移 PASS，future schema31 保护 PASS |
| NPC / 轮回 | 求援、人情债、仇怨伤亡、动态势力、重大人生、前尘旧缘等 | 旧系统完整保留 |
| 模拟充值 / VIP / 商城 | 0 | 尚未开发，继续被 Gate 阻塞 |

V3.3 已经把炼丹、命名材料与地图资源真正接成闭环：24 种丹药 / 丹方、48 类材料注册（其中 40 种新命名材料）进入统一物品、材料与丹方体系；丹方需要真实来源与资源，成丹拥有四档品质，失败会耗材，服丹受到丹毒与短期耐受约束，地图采集和敌人掉落承担明确材料来源。
...
- V3.3 schema30 是当前正式存档基线，后续版本必须继续提供逐级迁移。
...
| V3.2 法宝 / 炼器 | DONE |
| V3.3 炼丹 / 材料 | DONE |
| V3.4 战斗 / 四大道途 Build | TODO / CURRENT |
| V3.5 正常经济 / 世界整合 | TODO |
| V3.6 炼虚篇 | TODO |
| V3.7 合体篇 | TODO |
| V3.8 大乘篇 | TODO |
