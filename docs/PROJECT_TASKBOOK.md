...
> 创建日期：2026-08-23  
> 最近重大修订：2026-08-24 · V3.2 法宝、装备与炼器正式完成
> 当前正式基线：V3.2.0 · 法宝炼器体系 · build 3201 · save schema 29
...
| 存档 | schema29；保留 `xiuxian_world_v02` | schema28 → 29 迁移 PASS，future schema30 保护 PASS |
| NPC / 轮回 | 求援、人情债、仇怨伤亡、动态势力、重大人生、前尘旧缘等 | 旧系统完整保留 |
| 模拟充值 / VIP / 商城 | 0 | 尚未开发，继续被 Gate 阻塞 |

V3.2 已经解决法宝与装备数量过少、养成过浅的问题：60 件器物、24 件真正法宝已进入统一注册、炼制、装备与战斗体系；认主、祭炼、温养、本命化、重大失败受损与修复均有真实状态。

当前最明显短板转移到：

> **丹药仍只有 4 种，命名材料仍只有 8 类核心材料；地图危险、敌人掉落、炼丹配方与高境界资源之间还没有形成足够深的资源闭环。**

因此下一阶段进入 V3.3，优先扩展丹药、丹方、命名材料与明确来源。
...
- V3.2 schema29 是当前正式存档基线，后续版本必须继续提供逐级迁移。
