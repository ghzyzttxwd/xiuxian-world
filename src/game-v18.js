(() => {
'use strict';
const SAVE_KEY='xiuxian_world_v02'; const OLD_KEY='xiuxian_world_v01'; const VERSION='1.8.0'; const SAVE_SCHEMA_VERSION=15;
...
function realmLifespanFloor(index){return index>=19?1000:index>=15?500:index>=14?300:index>=10?150:82}
