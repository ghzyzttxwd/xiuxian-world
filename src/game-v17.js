(() => {
'use strict';
const SAVE_KEY='xiuxian_world_v02'; const OLD_KEY='xiuxian_world_v01'; const VERSION='1.7.0'; const SAVE_SCHEMA_VERSION=14;
...
function realmLifespanFloor(index){return index>=15?500:index>=14?300:index>=10?150:82}
