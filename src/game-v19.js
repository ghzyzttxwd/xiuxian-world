(() => {
'use strict';
const SAVE_KEY='xiuxian_world_v02'; const OLD_KEY='xiuxian_world_v01'; const VERSION='1.9.0'; const SAVE_SCHEMA_VERSION=16;
...
function validateCurrentSaveSchema(){
 const p=state.player,w=state.world,required=[['player.injury',p.injury],['player.sect',p.sect],['player.alchemyProf',p.alchemyProf],['player.gearOwned',p.gearOwned],['player.breakthroughAttempts',p.breakthroughAttempts],['player.coreEssence',p.coreEssence],['player.coreFailures',p.coreFailures],['player.nascentEssence',p.nascentEssence],['player.nascentFailures',p.nascentFailures],['player.deificationEssence',p.deificationEssence],['player.deificationFailures',p.deificationFailures],['player.dwellingTier',p.dwellingTier],['player.birthDay',p.birthDay],['player.secretRealmClears',p.secretRealmClears],['world.secretRealmCount',w.secretRealmCount],['world.factionClashes',w.factionClashes],['legacy',state.legacy]];
