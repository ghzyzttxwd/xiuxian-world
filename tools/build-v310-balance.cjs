...
// The full-run reached realm 33 with enough stones and all non-material Mahayana
// foundations, but the two already-existing scarce auction recovery lots were still locked
// at realm 34/35 even though the natal-origin action itself is intentionally reachable at
// realm 33. Align only those stock-1 auction access gates with the repaired preparation
// stage. Their map sources, material minRealm values, prices and stock remain unchanged.
must('{"id":"auction-v38-origincrystal","shopId":"shop-cangwu-auction","kind":"material","refId":"mat-v38-origin-crystal","basePrice":1800,"stock":1,"minRealm":34}','{"id":"auction-v38-origincrystal","shopId":"shop-cangwu-auction","kind":"material","refId":"mat-v38-origin-crystal","basePrice":1800,"stock":1,"minRealm":33}','pre-mahayana origin-crystal auction access');
must('{"id":"auction-v38-sourcecrystal","shopId":"shop-cangwu-auction","kind":"material","refId":"mat-v38-natal-source-crystal","basePrice":2400,"stock":1,"minRealm":35}','{"id":"auction-v38-sourcecrystal","shopId":"shop-cangwu-auction","kind":"material","refId":"mat-v38-natal-source-crystal","basePrice":2400,"stock":1,"minRealm":33}','pre-mahayana natal-source auction access');
...
if(!src.includes('"id":"auction-v38-origincrystal","shopId":"shop-cangwu-auction","kind":"material","refId":"mat-v38-origin-crystal","basePrice":1800,"stock":1,"minRealm":33'))throw new Error('pre-mahayana origin-crystal auction access missing');
if(!src.includes('"id":"auction-v38-sourcecrystal","shopId":"shop-cangwu-auction","kind":"material","refId":"mat-v38-natal-source-crystal","basePrice":2400,"stock":1,"minRealm":33'))throw new Error('pre-mahayana natal-source auction access missing');
