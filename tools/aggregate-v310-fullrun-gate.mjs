...
for(const p of requiredPaths){
 ...
 paths[p]={
  ...
  realmAges:{
   r14:realmAge(r,14),r19:a19,r23:a23,r30:a30,r34:a34,r37:a37,r39:a39
  },
...
// Stronger anti-dominance signal: a route must not be the unique youngest/fastest route at every
// major checkpoint from 结丹 through 真仙. Ties do not count as unique dominance. This is not a
// claim that every route must be equally fast; it only rejects a single path that wins the entire
// progression curve end-to-end under the fixed legal proof seeds.
