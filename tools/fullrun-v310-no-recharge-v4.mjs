...
const extra=[
 ...
 "\\nmustReplace(unitySeedAnchor,unitySeedEscape,'route every unity-seed request through normal unity integration');",
 ...
 "\\nif(!src.includes(\"if(id==='mat-v37-unity-seed'){ensureUnitySeeds(n);return}\"))throw new Error('unity-seed global routing guard missing');",
...
if(!stage.includes('route every unity-seed request through normal unity integration'))throw new Error('V3.10 full-run v4 unity routing injection missing');
