...
if(!runner.includes("tryAuctionMaterial('mat-v37-law-crystal',lawTarget,60)"))throw new Error('final runner missing normal auction preference for bulk law crystals');
...
console.log('V310_FULLRUN_V4_FINAL_RUNNER_PASS '+JSON.stringify({unitySeedRouting:true,batchedUnityPreparation:true,lawCrystalAuctionPreferred:true,mahayanaUnityStockConsumed:true,swordSpaceEscape:true,swordEscapeCooldownAware:true,realm37Cultivation:true,finalRunner:finalRunnerPath.pathname}));
