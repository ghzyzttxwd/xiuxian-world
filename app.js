...
(()=>{
  ...
  try{
    window.__TAIXUAN_BUILD__={engineeringVersion:'1.4.1',gameplayVersion:'1.3.0',build:'1402',milestone:'save-schema-pipeline',source:'src/game-v13.js',legacyPatchChain:false};
    document.title='太玄界 · 修仙大世界 V1.4';
    const script=document.createElement('script');
    script.src='./src/game-v13.js?v=1402';
    script.async=false;
    script.onload=()=>{
