...
(()=>{
  ...
  try{
    window.__TAIXUAN_BUILD__={engineeringVersion:'3.9.0',gameplayVersion:'3.9.0',build:'3903',milestone:'tribulation-ascension-true-immortal-finale',source:'src/game-v39.js',legacyPatchChain:false,ui:'final-v1',shop:'v2-heavy-singleplayer',shopPower:'m1'};
    ...
    const shopPower=document.createElement('script');shopPower.src='./ui-shop-v2-power-adapter.js?v=m1-1';shopPower.async=false;document.head.appendChild(shopPower);
