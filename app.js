...
(()=>{
  ...
  try{
    window.__TAIXUAN_BUILD__={engineeringVersion:'3.9.0',gameplayVersion:'3.9.0',build:'3903',milestone:'tribulation-ascension-true-immortal-finale',source:'src/game-v39.js',legacyPatchChain:false};
