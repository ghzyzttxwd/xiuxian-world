...
(()=>{
  ...
  try{
    window.__TAIXUAN_BUILD__={engineeringVersion:'3.9.0',gameplayVersion:'3.9.0',build:'3903',milestone:'tribulation-ascension-true-immortal-finale',source:'src/game-v39.js',legacyPatchChain:false,ui:'final-v1',shop:'v2-heavy-singleplayer',shopPower:'m1',shopVip8:'m2',shopVip12:'m3',shopVip15:'m4',shopDynamicPower:'m5',shopJadeSinks:'m6'};
    ...
    const shopPower=document.createElement('script');shopPower.src='./ui-shop-v2-power-adapter.js?v=m1-4';shopPower.async=false;document.head.appendChild(shopPower);
    ...
    const shopJade=document.createElement('script');shopJade.src='./ui-shop-v2-jade-sinks.js?v=m6-1';shopJade.async=false;document.head.appendChild(shopJade);
