// 太玄界 V3.9 渡劫飞升与真仙终局篇正式加载器 · build 3901
(()=>{
  ...
  try{
    ...
    const qolScript=document.createElement('script');qolScript.src='./ui-phase8-qol.js?v=2';qolScript.async=false;document.head.appendChild(qolScript);
