// 太玄界 V3.9 渡劫飞升与真仙终局篇正式加载器 · build 3902
(()=>{
  ...
  try{
    window.__TAIXUAN_BUILD__={engineeringVersion:'3.9.0',gameplayVersion:'3.9.0',build:'3902',milestone:'tribulation-ascension-true-immortal-finale',source:'src/game-v39.js',legacyPatchChain:false};
    ...
    const script=document.createElement('script');script.src='./src/game-v39.js?v=3902';script.async=false;script.onload=()=>{if(!window.__TAIXUAN_TEST__)fail(new Error('V3.9 直接源码运行时未完成初始化'))};script.onerror=()=>fail(new Error('V3.9 游戏核心加载失败：src/game-v39.js'));document.head.appendChild(script)
  }catch(e){fail(e)}
})();