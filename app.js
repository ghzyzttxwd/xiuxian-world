...
(()=>{
  ...
  try{
    ...
    const shopPower=document.createElement('script');shopPower.src='./ui-shop-v2-power-adapter.js?v=m1-2';shopPower.async=false;document.head.appendChild(shopPower);
